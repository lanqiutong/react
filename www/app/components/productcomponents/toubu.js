        ...
        return <div className="headerNav">
            <div className="header">
                <div className="headerMeau">
                    ...
                    <ul className="topNav">
                        <li>欢迎来到58花木兰!&nbsp;&nbsp;&nbsp;&nbsp;
                            {this.props.islogin?(<i>欢迎你！{this.props.username}</i>):(<div><NavLink to="/login"><i className="register">请登录&nbsp;&nbsp;&nbsp;&nbsp;</i></NavLink><NavLink to="/regist"><i className="login">免费注册</i></NavLink></div>)}
